...
typedef int	(*ElementDestroy)(void* _element);
 ...
 * @retval VECTOR_UNITIALIZED_ERROR If one of the parameters is equal to null, or VECTOR_OVERFLOW_ERROR if blockSize = 0, or VECTOR_REALLOCATION_ERROR.
 */
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR If one of the parameters is equal to null, or VECTOR_UNDERFLOW_ERROR if num of items = 0.
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR If one of the parameters is equal to null, or VECTOR_UNDERFLOW_ERROR if num of items = 0, or VECTOR_INDEX_OUT_OF_BOUNDS_ERROR.
 */
