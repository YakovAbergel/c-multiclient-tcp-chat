#ifndef __LISTGEN_H__
#define __LISTGEN_H__

#include <stddef.h> /* size_t */

typedef struct List List;

typedef void(*ElementDestroy1)(void* _item);
 ...
 * @returns error code
 * @retval LIST_SUCCESS on success
 * @retval LIST_UNINITIALIZED_ERROR if the list is not initialized or _pItem is NULL
