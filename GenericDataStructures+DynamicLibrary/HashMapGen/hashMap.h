...
typedef void (*ValDestroy)(void* _val);
 ...
 *
 * @warning _capacity must be >=  MIN_CAPASITY
 */
 ...
 */
void HashMap_Destroy(HashMap** _map, KeyDestroy _key, ValDestroy _value);
