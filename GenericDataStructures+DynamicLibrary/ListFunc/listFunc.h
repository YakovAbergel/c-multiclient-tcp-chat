 ...
 * @return an iterator pointing to the first node with data found or to _end if not or NULL if parameters not initialized or allocation failed 
 */
 ...
 * @param _predicate : Predicate function
 * @param _context : context to be passed to the predicate
 * @return count of all elements e where _predicate(e, _context) != 0 or -1 if parameters not initialized or -2 if allocation failed 
 */
 ...
 * @return ListItr to the element where the iteration stoped. this might be end iterator or NULL if parameters not initialized or allocation failed 
 */
